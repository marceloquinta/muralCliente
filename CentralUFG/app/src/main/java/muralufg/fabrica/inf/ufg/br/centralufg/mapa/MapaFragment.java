...
public class MapaFragment extends Fragment implements ServiceCompliant {
    ...
    /**
     * Adiciona uma marca na localização.
     */
    private void addMarker(final Location location) {
        ...
        markerOptions.title("Voce está aqui!").position(latLng);
    ...
    /**
     * Aproxima a camera para a localização do usuario.
     */
